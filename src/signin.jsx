    ...
    return (
         <div className='bg-gray-200 p-3 text-center w-1/2 m-auto rounded-md my-3'>
            <div className='m-6 text-left flex max-sm:flex-wrap'>
                ...
                <input type='text' name='name' id='name' className='rounded-md max-sm:w-[7rem]' onChange={handler4}></input>
            </div>
            <div className='m-6 text-left w-fit flex max-sm:flex-wrap'>
                ...
                <input type='email' name='email' id='email' className='rounded-md max-sm:w-[7rem]' onChange={handler1}></input>
            </div>
            <div className='m-6 text-left flex max-sm:flex-wrap'>
                <label htmlFor='password ' className='mr-4 text-black font-bold' >Password:</label>
                <input type='password' name='password' id='password' className='rounded-md max-sm:w-[7rem]' onChange={handler2}></input>
            </div>
